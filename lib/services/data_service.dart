  ...
  static List<Teknisi> getSampleTeknisi() {
    return [
      Teknisi(
        ...
        workloadStatusOverride: 'Sedang',
      ),
      Teknisi(
        id: 'TKN-002',
        name: 'Ridho Setiabudi',
        email: 'ridho.setiabudi@company.com',
      ...
      Teknisi(
        id: 'TKN-003',
        name: 'Citra Dewi Putri',
        email: 'citra.dewi.putri@company.com',
      ...
      Teknisi(
        id: 'TKN-004',
        name: 'Dedi Rahmansyah',
        email: 'dedi.rahmansyah@company.com',
        phone: '0815-6789-0123',
        specialization: 'Hardware & Maintenance',
        activeTickets: 4,
        skills: ['Hardware', 'Server', 'Maintenance'],
        division: 'Hardware & Maintenance',
        workloadStatusOverride: 'Sedang',
      ),
    ];
  }
