      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSectionHeader(
            ...
            'Konfigurasi SLA',
            'Atur batas waktu penanganan tiket',
          ),
          _buildCard(
            children: [
          ...
          _buildSectionHeader(
            ...
            'Atur kapan sistem mengirim notifikasi',
          ),
          _buildCard(
            children: [
              _buildSwitch(
              ...
              _buildSwitch(
                'Notifikasi Push',
                'Kirim push notification ke app',
                _notifPushAktif,
                (v) {
                  setState(() {
                    _notifPushAktif = v;
              ...
              _buildSwitch(
                'Alert SLA Kritis',
                'Notifikasi saat tiket mendekati deadline',
                _notifSLAAlert,
                (v) {
                  setState(() {
                    _notifSLAAlert = v;
              ...
              _buildSwitch(
                'Tiket Baru',
                'Notifikasi saat ada tiket masuk',
                _notifTicketBaru,
                (v) {
                  setState(() {
                    _notifTicketBaru = v;
          ...
          _buildSectionHeader(
            ...
            'Pengaturan Umum',
            'Konfigurasi perilaku sistem',
          ),
          _buildCard(
            children: [
              _buildSwitch(
                'Auto-Assign Teknisi',
                'Otomatis tugaskan teknisi berdasarkan workload',
                _autoAssign,
                (v) {
                  setState(() {
                    _autoAssign = v;
              ...
              _buildSwitch(
                'Persetujuan Admin',
                'Tiket perlu disetujui admin sebelum diproses',
                _requireApproval,
                (v) {
                  setState(() {
                    _requireApproval = v;
